...
(function () {
    ...
    function pt(e, t, n) {
        var o = "https://challenges.cloudflare.com", c, u = (c = n == null ? void 0 : n.origin) !== null && c !== void 0 ? c : o;
        if (t) {
            var g;
    ...
    function vt(e, t, n, o, c, u, g, h, f) {
        ...
        return "".concat(d, "/cdn-cgi/challenge-platform/").concat(w, "turnstile/f/ov2/av0/rch").concat(o, "/").concat(e, "/").concat(t, "/").concat(n.theme, "/").concat(C, "/").concat(g, "/").concat(n.size, "?lang=").concat(n.language).concat(S)
    }
    var mt = function (e) {
        var t, n, o = window.innerWidth < 400, c = e.state !== me.FailureFeedbackCode && (e.state === me.FailureFeedback || e.state === me.FailureHavingTroubles || !e.errorCode), u, g = F(Nr, (u = (t = e.displayLanguage) === null || t === void 0 ? void 0 : t.toLowerCase()) !== null && u !== void 0 ? u : "nonexistent"), h, f = F(Lr, (h = (n = e.displayLanguage) === null || n === void 0 ? void 0 : n.toLowerCase()) !== null && h !== void 0 ? h : "nonexistent");
        return o ? Fr({
    ...
    var yt = function (e, t, n, o) {
        var c = pt(t.params, !1, o), u = "h/".concat("b", "/"), g, h, f = "".concat(c, "/cdn-cgi/challenge-platform/").concat(u, "feedback-reports/").concat(Ge(e), "/").concat(t.displayLanguage, "/").concat((h = t.params.theme) !== null && h !== void 0 ? h : t.theme, "/").concat(n);
    ...
    function _r(e, t, n) {
        ...
        }), g; (g = u.nextNode()) !== null && o.length < n;) {
    ...
    function wr(e, t) {
        var n = e._pState;
        return n ? (t.isReady = n.isReady,
            t.isRecaptchaCompatibilityMode = n.isRecaptchaCompatibilityMode,
            t.lastWidgetIdx = n.lastWidgetIdx,
            t.scriptWasLoadedAsync = n.scriptWasLoadedAsync,
            t.upgradeAttempts = n.upgradeAttempts,
            t.upgradeCompletedCount = n.upgradeCompletedCount + 1,
            t.turnstileLoadInitTimeTsMs = j(),
            t.watchCatInterval = null,
            t.watchCatSeq = n.watchCatSeq,
            t.widgetMap = n.widgetMap,
            !0) : !1
    }
    function _t(e) {
    ...
    function zr(e) {
        ...
        try {
            for (var c = e.widgetMap[Symbol.iterator](), u; !(t = (u = c.next()).done); t = !0) {
                var g = Ce(u.value, 2), h = g[0], f = g[1], d;
                f.watchcat.seq = e.watchCatSeq,
                    f.watchcat.lastAckedSeq === 0 && (f.watchcat.lastAckedSeq = e.watchCatSeq);
                var w = J(h);
                if (!w || !f.shadow) {
                    f.watchcat.missingWidgetWarning || (b("Cannot find Widget ".concat(w, ", consider using turnstile.remove() to clean up a widget.")),
    ...
    function Pt() {
        var e = [er, tr];
        m.isRecaptchaCompatibilityMode && e.push(rr),
    ...
    function Hr(e) {
        ...
        if (!(t === void 0 || t.hasResponseParamEl)) {
            ...
            if (o) {
                ...
                c.type = "hidden";
                var u;
                c.name = (u = t.params["response-field-name"]) !== null && u !== void 0 ? u : st,
            ...
            if (m.isRecaptchaCompatibilityMode) {
                ...
                f.type = "hidden",
                    f.name = dt,
                    f.id = "".concat(e, "_g_response"),
                    t.wrapper.appendChild(f)
            }
        }
    }
    function Ir(e, t) {
        ...
        if (o !== null && V(o, HTMLInputElement) && (o.value = t),
            m.isRecaptchaCompatibilityMode) {
    ...
    function Lt(e, t) {
        ...
        switch (u) {
            ...
            case z.Managed:
                ...
                break;
            case z.Invisible:
                !Gr("floating-invisible", t) && t.params.sitekey === "0x4AAAAAAADnOjc0PNeA8qVm" ? (e.style.width = "1px",
                    e.style.height = "1px",
                    e.style.opacity = "0",
                    ...
                    e.style.transform = "translateX(-9999px)") : (e.style.width = "0",
                        e.style.height = "0",
                        e.style.position = "absolute",
    ...
    var Vt = (function () {
        var e = function (a, i, r, l) {
            ...
            , t = function (a, i, r) {
                if (a.params.retry === ge.Auto || r) {
                    a.isExecuted && (a.msgQueue.push(ce.Execute),
                        a.isExecuted = !0,
                        a.isExecuting = !0);
            ...
            , n = function (a, i, r) {
                var l;
                a.response === void 0 && v("[Internal Error] Widget was completed but no response was given", 1362),
                    a.isExecuting = !1,
                    a.isComplete = !0,
                    Ir(i, a.response),
                    (l = a.cbSuccess) === null || l === void 0 || l.call(a, a.response, r)
            }
            , o = function (a) {
                if (!a)
                    return [];
                for (var i = a.attributes, r = i.length, l = new Array(r), s = 0; s < r; s++)
                    l[s] = i[s].name;
                return l
            }
            , c = function (a, i, r) {
            ...
            , u = function () {
                ...
                do {
                    r = "";
                    for (var l = 0; l < 5; l++)
                        r += a.charAt(Math.floor(Math.random() * i))
            ...
            , f = function (a, i) {
                if (i) {
                    ...
                    l.length > 0 && v("The parameters ".concat(r.join(","), " is/are not allowed be changed between the calls of render() and execute() of a widget.\n    Consider rendering a new widget if you want to change the following parameters ").concat(l.join(",")), 3618),
                        i.action && (Et(i.action) || v('Invalid input for optional parameter "action", got "'.concat(i.action, '"'), 3604),
                            a.action = i.action),
                        i.cData && (Tt(i.cData) || v('Invalid input for optional parameter "cData", got "'.concat(i.cData, '"'), 3605),
                            a.cData = i.cData),
            ...
            , w = function (a, i) {
                ...
                if (l) {
                    ...
                    l.isResetting = !0,
                        ...
                        l.isStale = !1,
                        l.isOverrunning = !1,
                        l.watchcat.overrunBeginSeq = 0,
                        l.watchcat.lastAckedSeq = 0,
                        l.watchcat.seq = 0,
                        l.params.execution === ye.Render && (l.msgQueue.push(ce.Execute),
                            l.isExecuted = !0,
                            l.isExecuting = !0);
                    var y = J(r)
                        , x = l.shadow.querySelector("#".concat(y));
                    (!y || !x) && v("Widget ".concat(r, " to reset was not found."), 3330),
                        l.params.appearance === $.InteractionOnly && Rr(x),
                        l.params.sitekey === null && v("Unexpected Error: Sitekey is null", 3347);
                    var E = x.cloneNode(), I;
                    E.src = vt(r, l.params.sitekey, l.params, (I = l.rcV) !== null && I !== void 0 ? I : Q, !1, "b", a, m.scriptUrlParsed, lt(l)),
                        (s = x.parentNode) === null || s === void 0 || s.replaceChild(E, x),
                        Nt(y),
                        l.retryTimeout && window.clearTimeout(l.retryTimeout)
                } else
                    v("Widget ".concat(r, " to reset was not found."), 3331)
            }
            , S = function (a) {
                var i, r = R(a);
            ...
            , C = function (a, i) {
                ...
                if (typeof a == "string")
                    try {
                        ...
                        x || v('Unable to find a container for "'.concat(a, '"'), 3585),
                            y = x
                    } catch (Bt) {
                        v('Invalid type for "container", expected "selector" or an implementation of "HTMLElement", got "'.concat(a, '"'), 3586)
                    }
                else
                    V(a, HTMLElement) ? y = a : v('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
                var E = !0
                    , I = !1
                    , O = void 0;
                try {
                ...
                var W = Ft();
                if (!W)
                    return v("Turnstile cannot determine its page location", 3607);
                if (W.startsWith("file:"))
                    return v("Turnstile cannot run in a file:// url", 3608);
                var ue = Qr(y);
                if (ue) {
                    var p = Object.assign(ue, i), te = p.action, se = p.cData, be = p.chlPageData, q = p.sitekey, de;
                    ...
                    var Ee = p.callback
                        ...
                        , Re = p["before-interactive-callback"]
                        , ie = p["error-callback"]
                        , Ke = p["unsupported-callback"];
                    typeof q != "string" && v('Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(typeof q == "undefined" ? "undefined" : D(q), '"'), 3588),
                        Er(q) || v('Invalid input for parameter "sitekey", got "'.concat(q, '"'), 3589),
                        St(p.size) || v('Invalid type for parameter "size", expected normal|compact, got "'.concat(p.size, '" ').concat(D(p.size)), 3590),
                        _t(p.theme) || v('Invalid type for parameter "theme", expected dark|light|auto, got "'.concat(p.theme, '" ').concat(D(p.theme)), 3591),
                        bt(p.retry) || v('Invalid type for parameter "retry", expected never|auto, got "'.concat(p.retry, '" ').concat(D(p.retry)), 3592),
                        p.language || (p.language = "auto"),
                        It(p.language) || (b('Invalid language value: "'.concat(p.language, ", expected either: auto, or an ISO 639-1 two-letter language code (e.g. en) or language and country code (e.g. en-US).")),
                            p.language = "auto"),
                        Ct(p.appearance) || v('Unknown appearance value: "'.concat(p.appearance, ", expected either: 'always', 'execute', or 'interaction-only'."), 3600),
                        Ot(p.execution) || v('Unknown execution value: "'.concat(p.execution, ", expected either: 'render' or 'execute'."), 3601),
                        xt(p["retry-interval"]) || v('Invalid retry-interval value: "'.concat(p["retry-interval"], ', expected an integer value > 0 and < 900000"'), 3602),
                        wt(p["expiry-interval"]) || v('Invalid expiry-interval value: "'.concat(p["expiry-interval"], ', expected an integer value > 0 and < 360000"'), 3602);
                    var Ae, Y = (Ae = p["refresh-expired"]) !== null && Ae !== void 0 ? Ae : K.Auto;
                    Rt(Y) ? p["refresh-expired"] = Y : v('Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'.concat(Y, '" ').concat(typeof Y == "undefined" ? "undefined" : D(Y)), 3603);
                    ...
                    Et(te) || v('Invalid input for optional parameter "action", got "'.concat(te, '"'), 3604),
                        Tt(se) || v('Invalid input for optional parameter "cData", got "'.concat(se, '"'), 3605);
                    var Ie = u()
                        , ve = J(Ie);
                    if (!(!Ie || !ve)) {
                        var jt = []
                            , et = p.execution === ye.Render;
                        et && jt.push(ce.Execute),
                            m.lastWidgetIdx++;
                        var Or = {};
                        ...
                        tt || v("Turnstile Initialization Error ", 3606),
                            B.style.display = "none",
                            B.style.border = "none",
                            B.style.overflow = "hidden",
                            B.setAttribute("src", vt(Ie, q, p, Q, !1, "b", H.New, m.scriptUrlParsed, lt(tt))),
                            B.onerror = function () {
                                if (ie) {
                            ...
                            ;
                        var qt = ["cross-origin-isolated", "fullscreen", "autoplay"], rt;
                        F((rt = (l = document.featurePolicy) === null || l === void 0 || (r = l.features) === null || r === void 0 ? void 0 : r.call(l)) !== null && rt !== void 0 ? rt : [], ft) && qt.push(ft),
                            B.setAttribute("allow", qt.join("; ")),
                            B.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"),
                            B.id = ve;
                        var nt;
                        B.tabIndex = (nt = p.tabindex) !== null && nt !== void 0 ? nt : 0,
                            B.title = "Widget containing a Cloudflare security challenge",
                            Ut.appendChild(B);
                        ...
                        if (kr) {
                            ...
                            Ne.type = "hidden";
                            var it;
                            if (Ne.name = (it = p["response-field-name"]) !== null && it !== void 0 ? it : st,
                                Ne.id = "".concat(ve, "_response"),
                                pe.appendChild(Ne),
                                typeof p["response-field-name"] != "string" && Cr(q)) {
                                var Le = document.createElement("input");
                                Le.type = "hidden",
                                    Le.name = ut,
                                    Le.id = "".concat(ve, "_legacy_response"),
                                    pe.appendChild(Le)
                            }
                        }
                        if (m.isRecaptchaCompatibilityMode) {
                            ...
                            Fe.type = "hidden",
                                Fe.name = dt,
                                Fe.id = "".concat(ve, "_g_response"),
                                pe.appendChild(Fe)
                        }
                        return y.appendChild(pe),
                            tt.widgetRenderEndTimeTsMs = j(),
                            ve
                    }
                }
            }
            , T = function () {
                var a, i = -1, r = !0, l = !1, s = void 0;
                try {
                ...
                return i === -1 && v("Could not find widget", 43778),
                    a
            };
        function k() {
                    ...
                    switch (W.label) {
                        case 0:
                            ...
                            y = "h/".concat("b", "/"),
                                ...
                                E = "https",
                                I = "",
                                P = "".concat(E, "://").concat(x.host, "/cdn-cgi/challenge-platform/").concat(y, "rc/").concat(r).concat(I),
                                W.label = 1;
                        case 1:
                        ...
                        case 2:
                            return G = W.sent(),
                                G.status !== 200 ? (b("Cannot determine Turnstile's embedded location, aborting clearance redemption, are you running Turnstile on a Cloudflare Zone?"),
                                    n(_, a, !1)) : n(_, a, !0),
                                [3, 4];
                        case 3:
                            return ee = W.sent(),
                    ...
                    if (!(!i || !r))
                        switch (a.event) {
                            case "init":
                                {
                                    ...
                                    s || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                        r.mode = a.mode,
                                        r.nextRcV = a.nextRcV,
                                        r.mode === z.Invisible && r.params["refresh-expired"] === K.Manual && b("refresh-expired=manual is impossible in invisible mode, consider using '".concat(K.Auto, "' or '").concat(K.Never, ".'")),
                                        r.mode !== z.Managed && r.params["refresh-timeout"] !== oe.Auto && b("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                        r.params.appearance === $.Always || r.isExecuting && r.params.appearance === $.Execute ? Lt(s, r) : Rr(s),
                                        s.style.display = "";
                                    var y = r.shadow.querySelector("#".concat(i));
                                    y || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                        (l = y.contentWindow) === null || l === void 0 || l.postMessage({
                                            event: "init",
                                            source: U,
                                            widgetId: a.widgetId
                                        }, "*");
                            ...
                            case "translationInit":
                                {
                                    ...
                                    var E = new Map;
                                    r.displayLanguage = a.displayLanguage,
                                        Object.keys(a.translationData).forEach(function (Y) {
                            ...
                            case "languageUnsupported":
                                {
                                    b("Language ".concat(r.params.language, " is not supported, falling back to: ").concat(a.fallback, ".")),
                                        r.displayLanguage = a.fallback;
                                    break
                                }
                            case "reject":
                                {
                                    ...
                                    if (r.isExecuting = !1,
                                        I || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3075),
                                        a.reason === "unsupported_browser") {
                                        var O;
                            ...
                            case "fail":
                                {
                                    a.rcV && c(r, a.rcV, a.widgetId),
                                        a.cfChlOut && (r.cfChlOut = a.cfChlOut),
                                        a.cfChlOutS && (r.cfChlOutS = a.cfChlOutS),
                                        a.code && (r.errorCode = a.code),
                                        r.isExecuting = !1,
                                        r.isFailed = !0,
                                        r.isInitialized = !0,
                                        a.frMd && (r.frMd = a.frMd),
                                        Nt(i);
                                    var P = r.cbError
                                    ...
                                    if (P) {
                                        var ue;
                                        P(String((ue = a.code) !== null && ue !== void 0 ? ue : Zt)) ? r.params.retry === ge.Auto && !r.isResetting && t(r, i, G) : (a.code && b("Error: ".concat(a.code, ".")),
                                            t(r, i, G))
                                    } else
                                        a.code ? (t(r, i, G),
                                            v("Error: ".concat(a.code), 3076)) : t(r, i, !1);
                                    break
                                }
                            case "feedbackInit":
                                {
                            ...
                            case "requestFeedbackData":
                                {
                                    ...
                                    se || v("Received state for an unknown widget: #".concat(i, " / ").concat(a.widgetId), 3078),
                                        (te = se.contentWindow) === null || te === void 0 || te.postMessage({
                            ...
                            case "turnstileResults":
                                {
                                    ...
                                    de || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                        (q = de.contentWindow) === null || q === void 0 || q.postMessage({
                                            cfChlOut: r.cfChlOut,
                            ...
                            case "closeFeedbackReportIframe":
                                {
                                    ...
                                    xe || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                        mr("".concat(i, "-fr"));
                                    break
                                }
                            case "tokenExpired":
                                {
                                    var ne, we = a.token;
                                    r.isExpired = !0,
                                        (ne = r.cbExpired) === null || ne === void 0 || ne.call(r, we),
                                        r.params["refresh-expired"] === K.Auto && !r.isResetting && w(H.AutoExpire, i);
                                    break
                                }
                            case "interactiveTimeout":
                                {
                                    c(r, Q, a.widgetId),
                                        Nt(i);
                                    var fe = r.cbTimeout;
                                    if (fe ? fe() : r.params["refresh-timeout"] === oe.Never && !r.isResetting && b("The widget encountered an interactive timeout and is set to never refresh. Consider defining a timeout handler and resetting the widget upon timeout as solving a widget in a timed-out state is going to fail."),
                                        r.params["refresh-timeout"] === oe.Auto && !r.isResetting) {
                            ...
                            case "interactiveBegin":
                                {
                                    ...
                                    ke || v("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                        (Ee = r.cbBeforeInteractive) === null || Ee === void 0 || Ee.call(r),
                                        r.params.appearance === $.InteractionOnly && Lt(ke, r);
                                    break
                                }
                            case "interactiveEnd":
                                {
                            ...
                            case "requestExtraParams":
                                {
                                    ...
                                    var Re = r.shadow.querySelector("#".concat(i));
                                    Re || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                        r.isResetting = !1;
                                    var ie = {}
                                        , Ke = j()
                                        , Ae = {
                                    ...
                                    (Se = Re.contentWindow) === null || Se === void 0 || Se.postMessage(Pe({
                                        action: r.action,
        ...
        function R(_) {
            if (typeof _ == "string") {
                var a = Ge(_);
                if (a && m.widgetMap.has(a))
                    return a;
                if (m.widgetMap.has(_))
                    return _;
                try {
        ...
        return ot(Pe({}, N), {
            ...
            execute: function (a, i) {
                ...
                if (!r) {
                    ...
                    var l = C(a, i);
                    l || v("Failed to render widget", 43522),
                        r = l
                }
                ...
                if (s) {
                    ...
                    if (s.isExecuting = !0,
                        ...
                        var x;
                        s.isExecuting = !1,
                            b("Call to execute() on a widget that was already executed (".concat(y, "), execute() will return the previous token obtained. Consider using reset() before execute() to obtain a fresh token.")),
                            (x = s.cbSuccess) === null || x === void 0 || x.call(s, s.response, !1);
                        return
                    }
                    s.isExpired && b("Call to execute on a expired-widget (".concat(y, "), consider using reset() before.")),
                        s.isStale && (w(H.StaleExecute, y),
                            s.isExecuting = !0),
                        s.msgQueue.push(ce.Execute),
                        s.isExecuted = !0;
                    var E = s.shadow.querySelector("#".concat(y));
                    if (E || (s.isExecuting = !1,
                        v("Widget ".concat(y, " to execute was not found"), 43522)),
                        s.isResetting)
                        return;
                    if (s.isInitialized && h(s, r, E),
                        s.isInitialized && s.params.appearance === $.Execute && Lt(E, s),
                        s.isExecuting) {
                        var I, O = s.shadow.querySelector("#".concat(y));
                        O || v("Received state for an unknown widget: ".concat(r), 3078),
                            (I = O.contentWindow) === null || I === void 0 || I.postMessage({
                                event: "execute",
                                source: U,
                                widgetId: r
                            }, "*")
                ...
                if (typeof a == "undefined") {
                    ...
                    if (r) {
                        ...
                        return s != null && s.isExpired && b("Call to getResponse on a widget that expired, consider refreshing the widget."),
                            (l = m.widgetMap.get(r)) === null || l === void 0 ? void 0 : l.response
                    }
                    v("Could not find a widget", 43794)
                }
                var y = R(a);
                return y || v("Could not find widget for provided container", 43778),
                    (i = m.widgetMap.get(y)) === null || i === void 0 ? void 0 : i.response
            },
            implicitRender: Pt,
            ...
            ready: function (a) {
                if (m.scriptWasLoadedAsync && (b("turnstile.ready() would break if called *before* the Turnstile api.js script is loaded by visitors."),
                    v("Remove async/defer from the Turnstile api.js script tag before using turnstile.ready().", 3857)),
                    typeof a != "function" && v('turnstile.ready() expected a "function" argument, got "'.concat(typeof a == "undefined" ? "undefined" : D(a), '"'), 3841),
                    m.isReady) {
                    a();
                    return
                }
    ...
    function Qr(e) {
        ...
        if (u && (St(u) ? n.size = u : b('Unknown data-size value: "'.concat(u, '".'))),
            0)
            var g;
        ...
        if (w) {
            ...
            xt(S) ? n["retry-interval"] = S : b('Invalid data-retry-interval value: "'.concat(w, ', expected an integer value > 0 and < 900000".'))
        }
        ...
        k && (Rt(k) ? n["refresh-expired"] = k : b('Unknown data-refresh-expired value: "'.concat(k, ", expected either: 'never', 'auto' or 'manual'.")));
        ...
        R && (It(R) ? n.language = R : b('Invalid data-language value: "'.concat(R, ", expected either: auto, or an ISO 639-1 two-letter language code (e.g. en) or language and country code (e.g. en-US).")));
        function N(x) {
        ...
        a ? (Tr(a) || b('Invalid data-feedback-enabled value: "'.concat(a, ", expected either: 'true' or 'false'. Value is ignored.")),
            n["feedback-enabled"] = a === "true") : n["feedback-enabled"] = !0;
        ...
        return y && (Ct(y) ? n.appearance = y : b('Unknown data-appearance value: "'.concat(y, ", expected either: 'always', 'execute', or 'interaction-only'."))),
            n
    }
    function $r() {
        var e = !0;
        Mt(m, e),
            m.msgHandler && window.removeEventListener("message", m.msgHandler),
            xr(window.turnstile, m)
    }
    he = !1,
        A = vr(),
        m.scriptWasLoadedAsync = (Ye = A == null ? void 0 : A.loadedAsync) !== null && Ye !== void 0 ? Ye : !1,
        m.scriptUrl = (Qe = A == null ? void 0 : A.src) !== null && Qe !== void 0 ? Qe : "undefined",
        m.scriptUrlParsed = A == null ? void 0 : A.url,
        A != null && A.params && (_e = A.params.get("compat"),
            (_e == null ? void 0 : _e.toLowerCase()) === "recaptcha" ? window.grecaptcha ? b("grecaptcha is already defined. The compatibility layer will not be enabled.") : (b("Compatibility layer enabled."),
                m.isRecaptchaCompatibilityMode = !0,
                window.grecaptcha = Vt) : _e !== null && b('Unknown value for api.js?compat: "'.concat(_e, '", ignoring.')),
            A.params.forEach(function (e, t) {
                F(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], t) || b('Unknown parameter passed to api.js: "?'.concat(t, '=...", ignoring.'))
            }),
            he = A.params.get("_upgrade") === "true",
            X = A.params.get("onload"),
            X && !he && setTimeout(function () {
                typeof window[X] == "function" ? window[X]() : (b("Unable to find onload callback '".concat(X, "' immediately after loading, expected 'function', got '").concat(D(window[X]), "'.")),
                    setTimeout(function () {
        ...
        Dt = "turnstile" in window,
        Dt && !he ? b("Turnstile already has been loaded. Was Turnstile imported multiple times?") : (Dt && he && (wr(window.turnstile, m),
            kt(m),
            (A == null || ($e = A.params) === null || $e === void 0 ? void 0 : $e.get("render")) !== "explicit" && setTimeout(Pt, 0)),
            window.turnstile = Vt,
            he || ((A == null || (Je = A.params) === null || Je === void 0 ? void 0 : Je.get("render")) !== "explicit" && Wt.push(Pt),
                document.readyState === "complete" || document.readyState === "interactive" ? setTimeout(Sr, 0) : window.addEventListener("DOMContentLoaded", Sr))),
        Ar = 1440 * 60 * 1e3,
        window.setTimeout($r, Ar);
